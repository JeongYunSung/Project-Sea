...
public class TeamResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    .authorizeRequests()
                    .antMatchers(HttpMethod.GET, "/teams/**").access("#oauth2.hasScope('team_read')")
                    .antMatchers(HttpMethod.PUT, "/teams/**").access("#oauth2.hasScope('team_write')")

...
public class NotificationResourceServerConfiguration extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                    .authorizeRequests()
                    .antMatchers(HttpMethod.GET, "/notifications/**").access("#oauth2.hasScope('notification_read')")
